...
import { createUser, getUsers, getOneUser, updateOneUser, deleteOneUser, updateUserStatus, getSystemLogs } from '../../controllers/admin/usermanagement.js';
import {
...
router.get("/logs", getSystemLogs); // Must be before /:id
router.get("/", getUsers);
